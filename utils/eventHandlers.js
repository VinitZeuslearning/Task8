export default class Selectors {
    constructor(parentContainer, canvaInstant) {
        ...
        this.interactionContext = {
            mode: null, startX: 0, startY: 0, colLabel: null, rowLabel: null, colNumber: null, rowNumber: null
        };
    ...
    handleMouseMove(e) {
        ...
        if (ctx.mode === 'resize-row') {
            ...
            if (ctx.mode == "rowSelect") {
                ...
                document.body.style.cursor = rowLabel.isOnLine(e.clientX, e.clientY) !== -1 ? 'row-resize' : 'default';
            }
        }
            ...
            if (ctx.mode == "colSelect") {
                ...
                document.body.style.cursor = colLabel.isOnLine(e.clientX, e.clientY) !== -1 ? 'col-resize' : 'default';
            }
        }
    ...
    clearRowLabelSelection() {
        ...
        for (const inst of this.rowLableInstant.values()) {
            inst.render();
        }
    }
    ...
    clearColLabelSelection() {
        ...
        for (const inst of this.colLableInstant.values()) {
            inst.render();
        }
    }
    ...
    clearCellSelection() {
        ...
        this.renderCanvaSelection({
            startRow: 0, endRow: this.totalRow,
            startCol: 0, endCol: this.totalCol
        });
    }
